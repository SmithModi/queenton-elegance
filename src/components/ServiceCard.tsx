...
const ServiceCard: React.FC<ServiceCardProps> = ({ title, description, icon, delay = 0, onClick }) => {
  ...
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      className="group relative bg-card rounded-xl p-6 border border-border shadow-sm overflow-hidden cursor-pointer"
    ...
    >
      ...
      <div className="relative space-y-2">
        ...
        {/* Link */}
        <div className="mt-4 inline-flex items-center text-primary font-medium group cursor-pointer">
